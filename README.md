...
- **Main Documentation**: QUICK_START.md
- **Phase History**: PHASE1_SUMMARY.md, PHASE2_SUMMARY.md, PHASE4_IMPLEMENTATION_SUMMARY.md
- **API Reference**: JavaDoc in source code
- **Examples**: lance-flink-connector/src/example/
